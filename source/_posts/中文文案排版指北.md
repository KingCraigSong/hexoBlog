...
- [1. 目录](#1-目录)
- [2. 空格](#2-空格)
    - [2.1. 中英文之间需要增加空格](#21-中英文之间需要增加空格)
    - [2.2. 中文与数字之间需要增加空格](#22-中文与数字之间需要增加空格)
    - [2.3. 数字与单位之间无需增加空格](#23-数字与单位之间无需增加空格)
    - [2.4. 全角标点与其他字符之间不加空格](#24-全角标点与其他字符之间不加空格)
    - [2.5. `-ms-text-autospace` to the rescue?](#25--ms-text-autospace-to-the-rescue)
- [3. 标点符号](#3-标点符号)
    - [3.1. 不重复使用标点符号](#31-不重复使用标点符号)
- [4. 全角和半角](#4-全角和半角)
    - [4.1. 使用全角中文标点](#41-使用全角中文标点)
    - [4.2. 数字使用半角字符](#42-数字使用半角字符)
    - [4.3. 遇到完整的英文整句、特殊名词，其內容使用半角标点](#43-遇到完整的英文整句特殊名词其內容使用半角标点)
- [5. 名词](#5-名词)
    - [5.1. 专有名词使用正确的大小写](#51-专有名词使用正确的大小写)
    - [5.2. 不要使用不地道的缩写](#52-不要使用不地道的缩写)
- [6. 争议](#6-争议)
    - [6.1. 链接之间增加空格](#61-链接之间增加空格)
    - [6.2. 简体中文使用直角引号](#62-简体中文使用直角引号)
- [7. 工具](#7-工具)
- [8. 谁在这样做？](#8-谁在这样做)
- [9. 参考文献](#9-参考文献)
...
## 2.5. `-ms-text-autospace` to the rescue?
